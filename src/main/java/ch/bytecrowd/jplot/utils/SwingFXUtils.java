...
public final class SwingFXUtils {
    ...
    static int getBestBufferedImageType(PixelFormat<?> fxFormat, BufferedImage bimg, boolean isOpaque) {
        if (bimg != null) {
            ...
            if (bimgType == BufferedImage.TYPE_INT_ARGB || bimgType == BufferedImage.TYPE_INT_ARGB_PRE || (isOpaque
                    && (bimgType == BufferedImage.TYPE_INT_BGR || bimgType == BufferedImage.TYPE_INT_RGB))) {
    ...
    public static BufferedImage fromFXImage(Image img, BufferedImage bimg) {
        ...
        switch (fxFormat.getType()) {
            ...
            case BYTE_BGRA:
                ...
                if (bimg != null && (bimg.getType() == BufferedImage.TYPE_INT_BGR
